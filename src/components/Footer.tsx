    ...
    <footer className="bg-foreground text-background">
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-background/70 leading-relaxed text-sm mt-4">
              Sme slovenská spoločnosť s viac ako 20-ročnými skúsenosťami vo
              výrobe a montáži okien, dverí a fasádnych systémov.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="mt-6 pt-6 border-t border-background/20">
              <h4 className="text-sm font-light tracking-wide mb-3 text-background/50">
                Právne informácie
              </h4>
        ...
        <div className="border-t border-background/20 mt-12 pt-8 text-center text-background/50 text-sm">
          <p>
            &copy; {new Date().getFullYear()} ARGO SNV s.r.o. Všetky práva
            vyhradené.
          </p>
          <p className="mt-2">
            Created by{" "}
